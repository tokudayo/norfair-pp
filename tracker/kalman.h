...
inline static Matrix<FLOAT_T, 2, 4> CreateMeasurementMatrix() {
    Matrix<FLOAT_T, 4, 2> measurement_matrix;
...
inline static Matrix<FLOAT_T, 2, 2> CreateMeasurementUncertaintyMatrix(FLOAT_T r) {
    Matrix<FLOAT_T, 4, 4> measurement_uncertainty_matrix;
...
static const Matrix<FLOAT_T, 4, 4> H = CreateMeasurementMatrix();
static const Matrix<FLOAT_T, 4, 4> Q = CreateProcessUncertaintyMatrix(_Q);
static const Matrix<FLOAT_T, 4, 4> R = CreateMeasurementUncertaintyMatrix(_R);
...
public:
    ...
    Matrix<FLOAT_T, 4, 4> &F = F, &H = H, &Q = Q, &R = R, &I = I;
